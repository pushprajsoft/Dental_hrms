        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input type="password" id="tempPass" name="password" class="form-input" placeholder="Min 8 characters" required style="padding-right: 40px;">
                    <i class="fa-solid fa-eye toggle-password" onclick="togglePassword('tempPass', this)"></i>
                </div>
                @error('password') <small style="color: #EF4444; font-size: 0.8rem;">{{ $message }}</small> @enderror
            </div>
            
            <div class="form-group">
                <label for="tempPassConfirm">Confirm Password</label>
                <div style="position: relative;">
                    <input type="password" id="tempPassConfirm" name="password_confirmation" class="form-input" placeholder="Re-type the password" required style="padding-right: 40px;">
                    <i class="fa-solid fa-eye toggle-password" onclick="togglePassword('tempPassConfirm', this)"></i>
                </div>
            </div>
